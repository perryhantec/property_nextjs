...
const PropertyEditForm = ({ property }) => {
  ...
  return (
    <form action={updatePropertyById}>
      <h2 className='text-3xl text-center font-semibold mb-6'>更新租盤</h2>
      ...
      <div className='mb-4 bg-blue-50 p-4'>
        ...
        <input
          ...
          placeholder='地區'
          required
          defaultValue={property.location.district}
        />
        <input
          type='text'
          id='street'
        ...
        <input
          ...
          className='border rounded w-full py-2 px-3 mb-2'
          placeholder='大廈名稱'
          defaultValue={property.location.building}
        />
      </div>
        ...
        <div className='grid grid-cols-2 md:grid-cols-3 gap-2'>
          <div>
            <input
              ...
              value='amenity_1'
              className='mr-2'
              defaultChecked={property.amenities.includes('amenity_1')}
            />
          ...
          <div>
            <input
              ...
              value='amenity_2'
              className='mr-2'
              defaultChecked={property.amenities.includes('amenity_2')}
            />
          ...
          <div>
            <input
              ...
              value='amenity_3'
              className='mr-2'
              defaultChecked={property.amenities.includes('amenity_3')}
            />
          ...
          <div>
            <input
              ...
              value='amenity_4'
              className='mr-2'
              defaultChecked={property.amenities.includes('amenity_4')}
            />
          ...
          <div>
            <input
              ...
              value='amenity_5'
              className='mr-2'
              defaultChecked={property.amenities.includes('amenity_5')}
            />
          ...
          <div>
            <input
              ...
              value='amenity_6'
              className='mr-2'
              defaultChecked={property.amenities.includes('amenity_6')}
            />
          ...
          <div>
            <input
              ...
              value='amenity_7'
              className='mr-2'
              defaultChecked={property.amenities.includes('amenity_7')}
            />
          ...
          <div>
            <input
              ...
              value='amenity_9'
              className='mr-2'
              defaultChecked={property.amenities.includes('amenity_9')}
            />
          ...
          <div>
            <input
              ...
              value='amenity_10'
              className='mr-2'
              defaultChecked={property.amenities.includes('amenity_10')}
            />
          ...
          <div>
            <input
              ...
              value='amenity_11'
              className='mr-2'
              defaultChecked={property.amenities.includes('amenity_11')}
            />
          ...
          <div>
            <input
              ...
              value='amenity_12'
              className='mr-2'
              defaultChecked={property.amenities.includes('amenity_12')}
            />
          ...
          <div>
            <input
              ...
              value='amenity_13'
              className='mr-2'
              defaultChecked={property.amenities.includes('amenity_13')}
            />
          ...
          <div>
            <input
              ...
              value='amenity_14'
              className='mr-2'
              defaultChecked={property.amenities.includes('amenity_14')}
            />
          ...
          <div>
            <input
              ...
              value='amenity_15'
              className='mr-2'
              defaultChecked={property.amenities.includes('amenity_15')}
            />
